...
for h_idx, hrr_df in enumerate(real_dfs):
    ...
    for window_size in window_sizes:
        ...
        distance_df.to_csv(f'distance/{data_name}_{nn_k}NN_w{window_size}_3gt.csv')
        # compute_soft_dtw
        distance_matrix = pd.read_csv(f'distance/{data_name}_{nn_k}NN_w{window_size}_3gt.csv', index_col = 0).to_numpy()
